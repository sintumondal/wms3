...
@section('content')
   <div class="top-bar">
        ...
        <a href="add_allowance"><button type="button" class="btn btn-info">
         <span class="glyphicon glyphicon-search"></span>Add Allowance
        </button></a>
     </div>
        ...
        <div class=" mt-8 card shadow-lg p-3  bg-white rounded h-75">
           <div class=" items-center h-20">
              <h1 class="text-lg font-medium truncate mr-5"> List of Allowance </h1>
            </div>
            ...
            <div class="datatbl table-responsive">
                <table class="table table-striped table-bordered table-hover notice-types-table" id="tbl_allowance">
     ...
     <script type="text/javascript">
         ...
         function allowance_details(){
             
            $("#tbl_allowance").dataTable().fnDestroy();
                $('#tbl_allowance').dataTable({
    ...
    var table = $('#tbl_allowance').DataTable();
        table.on('draw.dt', function () {
            
            $('.edit_data').click(function () {
                var allowance_code = this.id;
                // alert(allowance_code);
                var datas = {'allowance_code': allowance_code, '_token': $('input[name="_token"]').val()};
                redirectPost('{{url("allowance_edit")}}', datas);
            });
                    ...
                    success: function (datam) {
                        ...
                        if (datam.status == 1) {
                            ...
                            $.alert({
                                ...
                                icon: 'fa fa-check',
                                title: 'Success!!',
                                content: '<strong>SUCCESS:</strong> Allowance Deleted Successfully.'
                            });
                        } else {
                            $.alert({
                                type: 'red',
