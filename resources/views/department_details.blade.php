   ...
   <div class="top-bar">
        ...
        <div class=" mt-8 card shadow-lg p-3  bg-white rounded h-75">
           <div class=" items-center h-20">
              <h1 class="text-lg font-medium truncate mr-5"> List of Department</h1>
            </div>
            ...
            <div class="datatbl table-responsive">
                <table class="table table-striped table-bordered table-hover notice-types-table" id="tbl_department">
     ...
     <script type="text/javascript">
         ...
         function department_details(){
            ...
            $("#tbl_department").dataTable().fnDestroy();
    ...
    var table = $('#tbl_department').DataTable();
        table.on('draw.dt', function () {
            
            $('.edit_data').click(function () {
                var department_code = this.id;
                var datas = {'department_code': department_code, '_token': $('input[name="_token"]').val()};
                redirectPost('{{url("department_edit")}}', datas);
            });
